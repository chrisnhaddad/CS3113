...
enum AnimationDirection { DOWN, LEFT, RIGHT, UP };
...
public:
    ...
    void move_left() { m_movement = glm::vec3(0.0f); m_movement.x = -1.0f; face_left(); }
    void move_right() { m_movement = glm::vec3(0.0f); m_movement.x = 1.0f;  face_right(); }
    void move_up() { m_movement = glm::vec3(0.0f); m_movement.y = 1.0f;  face_up(); }
    void move_down() { m_movement = glm::vec3(0.0f); m_movement.y = -1.0f; face_down(); }
    ...
    const std::string& get_poke_name() const { return m_poke_name; }
    bool get_caught() const { return m_caught; };
    ...
    void set_poke_name(const std::string &new_name) { m_poke_name = new_name; }
    void set_caught() { m_caught = true; };

    static std::vector<Entity*> party;
