                ...
                switch (event.key.keysym.sym) {
					...
					case SDLK_RETURN:
						...
						if (g_current_scene == g_menu) {
							//g_current_scene->get_state().next_scene_id = 1; // Index of LevelA in your g_levels array
...
void render()
{
    ...
    if (g_current_scene != g_menu) {
        std::string lives_text = "Lives: " + std::to_string(g_lives);
        Utility::draw_text(&g_shader_program, Utility::load_texture("assets/font1.png"), lives_text, 0.4f, 0.1f, glm::vec3(1.0f, 3.0f, 0));
    }
